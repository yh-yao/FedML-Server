...
from FedML.fedml_api.distributed.fedprox.FedProxAggregator import FedProxAggregator
from FedML.fedml_api.distributed.fedprox.FedProxServerManager import FedProxServerManager
from FedML.fedml_api.distributed.fedprox.MyModelTrainer import MyModelTrainer
...
if __name__ == '__main__':
    ...
    server_manager = FedProxServerManager(args,
                                         aggregator,
                                         rank=0,
                                         size=size,
                                         backend="MQTT",
